...
.disk [filename="musicdisk.d64", name="SYSTEM BEEPS", id="2021!" ] {
        ...
        [ name=@"\$00\$FF\$FF\$00\$00\$0E\$00", type="rel" ],
        [ name="----------------", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        ...
        [ name=" --  --  --  -- ", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        [ name="oRIGINAL ms-dos ", type="rel"                      ],
        [ name="MUSIC ALBUM WAS ", type="rel"                      ],
        [ name="COMPOSED BY     ", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        [ name="           sHIRU", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        [ name="pORTED TO THE   ", type="rel"                      ],
        [ name="cOMMODORE 64 BY ", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        [ name="          XtIBOR", type="rel"                      ],
        [ name="                ", type="rel"                      ],
        [ name="i HOPE YOU'LL   ", type="rel"                      ],
        [ name="ENJOY THIS DISK ", type="rel"                      ],
        [ name="DESPITE THE     ", type="rel"                      ],
        [ name="SPARTAN VISUALS.", type="rel"                      ],
        [ name="----------------", type="rel"                      ],
}
